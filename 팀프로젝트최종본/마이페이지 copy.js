...
window.addEventListener('load', async () => {
    ...
    async function loadHTML() {
        ...
        const openBtn = document.getElementById("open-f");
        ...
        const changeRoomBtn = document.getElementById("change_room");
        const changeTimeBtn = document.getElementById("change_time");
        const editModal = document.getElementById("edit_modal");

        const roomSelectBox = document.getElementById("room_select");
        const timeSelectBox = document.getElementById("time_select");

        const roomOption = document.getElementById("room_option");
        const timeOption = document.getElementById("time_option");

        const saveBtn = document.getElementById("save_btn");
        const closeBtn = document.getElementById("close_btn");

        const roomTextBox = document.getElementById("room_text_box");
        const roomImage = document.getElementById("reservation_info_img");
        ...
        const roomImages = {
            ...
            "801호": "https://chatgpt.com/backend-api/estuary/public_",
            "802호": "https://chatgpt.com/backend-api/estuary/public_",
            "803호": "https://chatgpt.com/backend-api/estuary/public_",
            "804호": "https://chatgpt.com/backend-api/estuary/public_",
            "805호": "./Img/랩실6.png",
            "806호": "./Img/랩실1.png",
            "807호": "https://chatgpt.com/backend-api/estuary/public_",
            "808호": "https://chatgpt.com/backend-api/estuary/public_",
            "809호": "https://chatgpt.com/backend-api/estuary/public_",
            "810호": "https://chatgpt.com/backend-api/estuary/public_",
            "811호": "./Img/랩실1.png"
        };
        ...
        function parseHoursFromText(timeText) {
            const match = String(timeText).match(/(\d{1,2}):00\s*~\s*(\d{1,2}):00/);
            if (!match) return 0;
        ...
        let info = {
            center: params.get("center") || "클로버 허브 교육센터",
            reserver: "김OO",
            room: params.get("room") || "703호",
            date: params.get("date") || "2026-04-02",
            person: params.get("person") || "1",
            start: params.get("start"),
            end: params.get("end"),
            hour: params.get("hour")
        };

        if ((!info.hour || info.hour === "null") && info.start !== null && info.end !== null) {
            info.hour = String(calcHour(info.start, info.end));
        }

        if (info.start !== null && info.end !== null) {
            info.time = `${pad2(info.start)}:00 ~ ${pad2(info.end)}:00`;
        } else if (info.hour) {
            info.time = `${info.hour}시간`;
        } else {
            info.time = "시간 정보 없음";
        }

        function render(data) {
            const hours = data.hour ? parseInt(data.hour, 10) : parseHoursFromText(data.time);
            const totalPrice = pricePerHour * (isNaN(hours) ? 0 : hours);

            roomTextBox.innerHTML = `
                <strong>|${data.center}|</strong><br><br>
                예약자: ${data.reserver}<br>
                호실: ${data.room}<br>
                이용 일자: ${data.date}<br>
                예약 인원: ${data.person}명<br>
                총 이용 시간: ${data.time} (${hours}시간)<br>
                총 주문 금액: ${formatNumber(totalPrice)}원<br>
                운영 시간: 24시간 연중무휴
            `;

            roomImage.src = roomImages[data.room] || "./Img/강의실내부4.png";

            const dateParts = String(data.date).split("-");
            if (dateParts.length >= 2) {
                selectedPeriod.textContent = `${dateParts[0]}년 ${parseInt(dateParts[1], 10)}월`;
            }
        }
        ...
        changeTimeBtn.addEventListener("click", function () {
            ...
            timeOption.value = info.time.includes("~") ? info.time : "09:00 ~ 12:00";
        });

        saveBtn.addEventListener("click", function () {
            if (editType === "room") {
                info.room = roomOption.value;
            }

            if (editType === "time") {
                info.time = timeOption.value;
                const match = info.time.match(/(\d{1,2}):00\s*~\s*(\d{1,2}):00/);
                if (match) {
                    info.start = match[1];
                    info.end = match[2];
                    info.hour = String(parseInt(match[2], 10) - parseInt(match[1], 10));
                }
            }
        ...
        document.getElementById("cancel_btn").addEventListener("click", function () {
            if (confirm("예약을 취소하시겠습니까?")) {
                ...
                window.history.replaceState({}, document.title, "reservation_information.html");
                alert("예약이 취소되었습니다.");
            }
        });
